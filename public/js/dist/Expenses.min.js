...
return b}},function(a){var b=function(){};b.prototype={isValid:function(a){var b=!1;return a.has("input[type=radio]").length?b=this.isValidRadio(a):a.has("input[type=text]").length?b=this.isValidText(a):a.has("input[type=number]").length?b=this.isValidNumber(a):a.has("input[type=date]").length,this.updateState(b,a),b},updateState:function(a,b){a?b.removeClass("invalid"):b.addClass("invalid")},isValidText:function(a){var b=this.getElement(a,"input[type=text].tt-input"),c=b.val().trim();return c.length>0?!0:!1},isValidRadio:function(a){var b=this.getElement(a,"input[type=radio]:checked");return window.radio=b,void 0!==b.val()?!0:!1},isValidNumber:function(a){var b=this.getElement(a,"input[type=number]");return parseInt(b.val())?!0:!1},getElement:function(a,b){if(a.is(b))return a;var c=a.find(b);return c}},a.fn.validate=function(){var c=new b;return this.each(function(){return c.isValid(a(this))})}}(jQuery);var app=app||{};$(document).ready(function(){if(app.autocomplete){var a,b=new Autocomplete;a=b.datumize(app.autocomplete.titles)}FastClick.attach(document.body),$(".btn-group").button(),$(".actions__toggle").on("click",function(){$(this).closest(".expense__container").toggleClass("open").closest(".expense__frame").toggleClass("open")});var c=new Bloodhound({datumTokenizer:function(a){return Bloodhound.tokenizers.whitespace(a.val)},queryTokenizer:Bloodhound.tokenizers.whitespace,local:a});c.initialize(),$(".typeahead").typeahead(null,{displayKey:"val",source:c.ttAdapter()}),$(".add-form input[type=submit], .edit-form input[type=submit]").on("click",function(){return $(".mandatory").validate(),$(".invalid").length?!1:!0})});